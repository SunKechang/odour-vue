module.exports = {
    ...
    home:{
        title:'BFU Food Flavor Database2.0',
        notice:'Notice',
        summary:'Summary',
        add:' has been added.',
    ...
    about:{
        ...
        labTeam: {
            bigTitle: 'Introduction to the research team',
            introduction: {
            ...
            field:{
                ...
                content:["1. Flavor quality evaluation of forestry fruits and their value-added products. ",
                "2. Technology of fruit wine production.",
                "3. Application of sensory evaluation method in development and quality control of forest products. ",
                "4. Detection of fraud and adulteration for forest fruit products."]
            },
            article: {
                title: 'Publish One’s Thesis',
            }
            
        },
        workTeam: {
            title: 'Introduction to the development team',
            content: '无'
        },
        agency: {
            bigTitle: 'Introduction to cooperative institutions',
            company: {
    ...
    footer:{
        ...
        contact: 'CONTACT US',
        developer: 'DEVELOPER',
        zhuQr: 'Wechat Official Account',
        tianQr: 'Wechat Official Account'
    },
    view:'View',
    reset:'Reset',
    compound:{
