<template>
    <div class="compound-info-form">
        ...
        <el-form :model="productInfoForm" :rules="rules" ref="compoundInfoForm" label-width="200px" >
            <el-form-item label="Product Name" prop="compoundName" >
                <el-input v-model="productInfoForm.compoundName" clearable style="width: 500px"></el-input>
            </el-form-item>
            <el-form-item label="Synonym" prop="synonym" >
                <el-input type="textarea" v-model="productInfoForm.synonym" clearable></el-input>
            </el-form-item>
            <el-form-item label="CAS NO." prop="casNo" >
                <el-input v-model="productInfoForm.casNo" clearable style="width: 200px"></el-input>
            </el-form-item>
<!--极性-->
            <el-form
                    ref="riForm"
                    ...
                    label-width="200px">
                <div v-for="(item, index) in productInfoForm.riList" :key="index">
                    <el-form-item
                            label="(polar)RI"
...
<!--非极性-->
            <el-form
                    ...
                    :model="productInfoForm"
                    label-width="200px">
                <div v-for="(item, index) in productInfoForm.nriList" :key="index">
                    <el-form-item
                            label="(non-polar)RI"
...
<!--            </el-form-item>-->
            ...
            <el-form
                    ...
                    :model="productInfoForm"
                    label-width="200px">
                <div v-for="(item, index) in productInfoForm.otList" :key="index">
                    <el-form-item
...
<!--            风味描述-->
            <el-form
                    ...
                    :model="productInfoForm"
                    label-width="200px">
                <div v-for="(item, index) in productInfoForm.odList" :key="index">
                    <el-form-item
...
<!--            </el-form-item>-->
            ...
            <el-form
                ...
                <br>
                <div v-for="(item, index) in productInfoForm.mrList" :key="index">
                    <el-form-item
                            label="Measured"
            ...
            <el-form
                ...
                <br>
                <div v-for="(item, index) in productInfoForm.lowmrList" :key="index">
                    <el-form-item
                            label="Measured"
        ...
        methods: {
            ...
            onChangeChemicalStructure(){
                ...
                convertImgToBase64(chemicalStructure,(base64Str)=>{
                    this.productInfoForm.chemicalStructure=base64Str;
                },()=>{
                    console.log("convert error");
                });
                console.log(this.productInfoForm.chemicalStructure)
            },
            onChangeMassSpectrogram(){
                ...
                convertImgToBase64(massSpectrogram,(base64Str)=>{
                    this.productInfoForm.massSpectrogram=base64Str;
                },()=>{
                    console.log("convert error");
                });
            },
            onChangeMassSpectrogramNist(){
                ...
                convertImgToBase64(massSpectrogramNist,(base64Str)=>{
                    this.productInfoForm.massSpectrogramNist=base64Str;
                },()=>{
                    console.log("convert error");
                });
            },
            addot(){
                this.productInfoForm.otList.push({
                    id:'',
                    odourThreshold:0,
                    odourThresholdReference:'',
                    odourBase:'',
            ...
            removeot(item,index){
                this.productInfoForm.otList.splice(index, 1);
            },
            addod(){
                this.productInfoForm.odList.push({
                    id:'',
                    odourDescription:'',
                    odourDescriptionReference:'',
                    compoundId:''
            ...
            removeod(item,index){
                this.productInfoForm.odList.splice(index, 1);
            },
            addRI(){
                this.productInfoForm.riList.push({
                    id:'',
                    compoundRi: 0,
            ...
            removeRI(item,index){
                this.productInfoForm.riList.splice(index, 1);
            },
            addNRI(){
                this.productInfoForm.nriList.push({
                    id:'',
                    compoundNri: 0,
                    chromatographicColumn: 0,
                    nriResource:'',
            ...
            removeNRI(item,index){
                this.productInfoForm.nriList.splice(index, 1);
            },
            addMR(){
                this.productInfoForm.mrList.push({
                    id:'',
                    measured: 0,
                    relativeAbundance: 0,
                    compoundId:''
            ...
            removeMR(item,index){
                this.productInfoForm.lowmrList.splice(index, 1);
            },
            addlowMR(){
                this.productInfoForm.lowmrList.push({
                    id:'',
                    measured: 0,
                    relativeAbundance: 0,
                    compoundId:''
